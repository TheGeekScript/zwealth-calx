...
<body>
  <nav class="navbar navbar-light bg-light ">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand" href="#">
        <img src="img/logo.png" alt="ZWealth Logo" width="300" class="mx-auto d-inline-block align-text-top">
      </a>
    </div>
  </nav>
                  ...
                  <div class="mb-3">
                    <div class="row">
                      <div class="col">
                        ...
                        <input type="number" class="form-control" id="currentAge" name="currentAge" required value="35">
                      </div>
                      <div class="col">
                        <label for="monthlyIncomeRequired" class="form-label">Monthly Expenses (₹)</label>
                        <input type="number" class="form-control" id="monthlyIncomeRequired" name="monthlyIncomeRequired" required value="35000">
                      </div>
                    </div>
                  </div>
                  <div class="mb-3">
                    <div class="row">
                      <div class="col">
                        <label for="retirementAge" class="form-label">Retirement Age (Years)</label>
                  ...
                  <div class="mb-3">
                    <div class="row">
                      <div class="col">
                        ...
                        <input type="number" class="form-control" id="existingRetirementFund" name="existingRetirementFund" required value="10000">
                      </div>
                      <div class="col">
                  ...
                  <div class="mb-3">
                    <div class="row">
                      <div class="col">
                        ...
                        <input type="number" class="form-control" id="preRetirementReturn" name="preRetirementReturn" required value="15">
                      </div>
                      <div class="col">
  ...
  <div class="container mt-5">
      <div class="row col-md-12 justify-content-center">
				<img src="img/banner2.png" alt="" class="mx-auto img-responsive">
			</div>
    <form id="infoform" method="POST" class="row bg-light p-4">
        <div class="col-md-3">
            <input type="text" class="form-control" id="infoform_name" name="name" placeholder="Name" required>
        </div>
        <div class="col-md-3">
            <input type="email" class="form-control" id="infoform_email" name="email" placeholder="Email" required>
        </div>
        <div class="col-md-3">
            <input type="tel" class="form-control" id="infoform_phone" name="phone" placeholder="Phone" required>
        </div>
        <div class="col-md-3">
            <button type="submit" class="btn btn-primary mb-3 text-uppercase">I'm ready to invest</button>
        </div>
    </form>
    <div id="infoform_message" class="mt-3 pt-3"></div>
  </div>

  <div class="container-fluid">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
      <div class="col-md-6 d-flex align-items-center">
        <span class="text-muted">© 2024 - <?=date('Y');?> ZWealth. All Rights Reserved.</span>
      </div>

      <ul class="nav col-md-6 justify-content-end list-unstyled d-flex">
        <li class="ms-3">
          <a class="text-muted" target="_blank" href="https://www.facebook.com/profile.php?id=61566605033208&mibextid=LQQJ4d">
        ...
        <li class="ms-3">
          <a class="text-muted" target="_blank" href="https://www.instagram.com/zwealth.in">
  ...
  document.getElementById('retirementForm').addEventListener('submit', function(event) {
    ...
    // Step 2: Calculate Additional Income Required for Retirement
    const retirementYears = lifeExpectancy - retirementAge;
    const additionalIncomeRequired = annualIncomeRequired * ((1 - Math.pow(1 + postRetirementReturn, -retirementYears)) / postRetirementReturn);

    // Step 3: Calculate Monthly Savings Required to Retire
    ...
    const monthlySavingsRequired = (additionalIncomeRequired - futureValueOfExistingFund) * (monthlyRate / (Math.pow(1 + monthlyRate, totalPayments) - 1));
    ...
    document.getElementById('totalCorpusRequired').innerText = `₹${formatNumber(additionalIncomeRequired)}`;
  ...
  document.getElementById('othergoal_emailForm').addEventListener('submit', async function (event) {
    ...
    document.getElementById('infoform').addEventListener('submit', async function (event) {
      ...
      const infoform_name = document.getElementById('infoform_name').value;
      const infoform_email = document.getElementById('infoform_email').value;
      const infoform_phone = document.getElementById('infoform_phone').value;
      try {
          const response = await fetch('mails/sendform.php', {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/x-www-form-urlencoded',
              },
              body: `infoform_name=${encodeURIComponent(infoform_name)}&infoform_email=${encodeURIComponent(infoform_email)}&infoform_phone=${encodeURIComponent(infoform_phone)}`,
          });

          const result = await response.text();
          document.getElementById('infoform_message').innerHTML = result;
      } catch (error) {
          console.error('Error:', error);
          document.getElementById('infoform_message').innerHTML = '<div class="alert alert-danger alert-dismissible fade show">An error occurred. Please try again.<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
      }
    });
</script>
