...
// Get form data
$email = $_POST['othergoal_email'];
$data  = json_decode($_POST['othergoal_emailData'], true); // Decode the JSON string
$calcEmailType = $_POST['othergoal_calctype']; // Calculator type
...
<table cellspacing="0" cellpadding="10" border="1" style="font-size:11px">
    ...
    <tr>
        <td>Recommended Target Amount (Rs.)</td>
        <td>'.$data['recommendedTargetAmount'].'</td>
    </tr>
    <tr>
        <td>Required Investment Amount (Rs.)</td>
        <td>'.$data['requiredInvestmentAmount'].'</td>
    </tr>
</table>
';
